...
function Editor (state) {
  ...
  this.openGithub = item({ id: 'github', text: 'GitHub repo' })
  ...
  this.saveGist = item({ id: 'gist', text: 'Gist' })
  this.saveDropdown = dropdown({ id: 'save', text: 'Save', elements: [
    this.saveGist
  ]})
  ...
  this.saveDropdown.addEventListener('click', function (e) {
    self.render(self.state)
  })
  ...
  this.saveDropdown.addEventListener('close', function (e) {
    self.render(self.state)
  })
...
Editor.prototype.render = function (state) {
  ...
  this.menu.render([
    ...
    this.saveDropdown.render(state.menu.dropdowns.save),
